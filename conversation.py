...
class DialogManager:
    ...
    def _is_valid_transition(
        ...
        valid_transitions = {
            ...
            DialogState.PROCESSING: {DialogState.THINKING, DialogState.IDLE, DialogState.LISTENING},
            DialogState.THINKING: {DialogState.SPEAKING, DialogState.INTERRUPTED, DialogState.IDLE},
            DialogState.SPEAKING: {DialogState.IDLE, DialogState.INTERRUPTED, DialogState.LISTENING},
...
class BargeInDetector:
    ...
    def __init__(
        ...
        self._frames_needed = int(min_duration_ms * sample_rate / 1000 / 320)  # 假设每帧320采样
    ...
    def set_modules(
        ...
        if self.tts_session:
            self.dialog_manager.register_callback(
                ...
                lambda e, d: self.tts_session.interrupt()
            )
        
        if self.audio_player:
            self.dialog_manager.register_callback(
                DialogEvent.BARGE_IN,
                lambda e, d: self.audio_player.interrupt()
            )
